...
const TOKEN_LIST = [
  ...
  },
  {
    symbol: 'TKA',
    name: 'Test Token A',
    address: '0x...', // Your Test Token A address
    decimals: 18,
  ...
  },
  {
    symbol: 'TKB',
    name: 'Test Token B',
    address: '0x...', // Your Test Token B address
    decimals: 18,
...
const ROUTER_ADDRESS = '0x...'; // Your YafaRouter address
const FACTORY_ADDRESS = '0x...'; // Your YafaFactory address
      ...
      <div className="relative z-10 flex justify-between items-center mb-12 max-w-7xl mx-auto">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-green-500/80 text-sm font-medium mt-1">Decentralized exchange</p>
          </div>
        </div>
