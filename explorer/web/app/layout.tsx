        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex items-center space-x-4 text-xs text-green-600/60">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <Link href="/" className="text-green-500/70 hover:text-green-400 transition-colors">
                    Latest Blocks
                  </Link>
                </li>
                <li>
                  <Link href="/transactions" className="text-green-500/70 hover:text-green-400 transition-colors">
                    Recent Transactions
                  </Link>
                </li>
                <li>
                  <Link href="/stats" className="text-green-500/70 hover:text-green-400 transition-colors">
                    Network Statistics
                  </Link>
                </li>
                <li>
                  <a 
                    href={process.env.NEXT_PUBLIC_BRIDGE_URL || 'http://localhost:3001'} 
            ...
            {/* Network Info */}
            <div>
              <h3 className="text-green-400 font-semibold mb-4">Network</h3>
              <ul className="space-y-2 text-sm text-green-500/70">
                <li>Chain ID: 42069</li>
                <li>Network: Yafa L2</li>
                <li>Type: Layer 2 Rollup</li>
                <li>Status: 
          ...
          <div className="mt-8 pt-8 border-t border-green-500/20 flex flex-col md:flex-row justify-between items-center">
            <p className="text-green-500/60 text-sm">
              © 2024 YAFA L2 Explorer. Powered by YAFA Technology.
            </p>
